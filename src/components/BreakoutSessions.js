    ...
    <div className='container' id='breakout'>
      ...
      <div className="speaker-cards-layout">
        ...
        {DisplaySpeakerCard(
          'leslie_benningfield',
          'Leslie Benningfield',
          'I work for the University of KY Medical Center (Kentucky Cancer Registry), my title is Regional Abstractor Coordinator. I report cancer cases to our office in the Western part of the state. I travel to hospitals as well as work remotely.  I went to WKU. I have an AS in Business & also an AS in HIM.  I have also taught night classes in the past in coding at SKY.  I started out being a coder at a hospital in Nashville, but then transferred to Greenview for several years as being a Cancer Registrar.  I have my CTR as well as my RHIT certifications.  I have been doing Cancer Registry now for 16 years.  On the side, I also teach spinning  & other classes here in town at BAC. I have two boys ages, 11 & 21. :o) I\'m willing to help students anyway I can, as I wish a mentor would have been available when I attended college.  I believe it would have been so very helpful',
          true
        )}        
